...
// * @author micycle1
// */
//public class ArrowOld implements Serializable {
//
...
//
//	public ArrowOld(State tail, State head) {
//		ID = this.hashCode();
//		this.tail = tail;
//		this.head = head;
...
//					case 0 : // Modify
//						modifyBuffer = new modifyTransition(ArrowOld.this);
...
//						break;
//					case 1 : // Delete
//						HistoryHandler.buffer(new deleteTransition(ArrowOld.this));
//						stateOptions.hide();
//						break;
//					default :
//						break;
...
//		for (ArrowOld a : head.getOutgoingArrows()) {
